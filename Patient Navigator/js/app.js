...
import { renderDocReads } from './pages/docreads.js';
...
const APP_BUILD = '20260925b';  // bumped on every breaking deploy
let appBooted = false;
...
async function init() {
  ...
  registerRoute('docreads', (c) => renderDocReads(c), { requiresAuth: true, roles: ['admin', 'manager'] });
